const peopleData = {
  current: {
    ...
    PhD: [
      ...
      { name: "Mahesh", image: "people/current/PhD/Mahesh.jpg", year: "2023", email: "malavm23@iitk.ac.in", focus: "top" },
  ...
  alumni: {
    Masters: [
      ...
      { name: "Elluru Sairam", image: "people/alumni/MTech/sairam.jpg", linkedin: "[LinkedIn URL]", year: "[Graduation Year]", focus: "center" },
    ...
    PhD: [
      ...
      { name: "Manish Kaushal", image: "people/alumni/PhD/manish.JPG", linkedin: "https://www.linkedin.com/in/manish-kaushal-b5663611?utm_source=share_via&utm_content=profile&utm_medium=member_android", year: "2015", focus: "top" },
      ...
      { name: "Yogesh Nimdeo", image: "people/alumni/PhD/yn.jpg", linkedin: "https://www.linkedin.com/in/dr-yogesh-nimdeo-06485b10?utm_source=share_via&utm_content=profile&utm_medium=member_android", year: "2017", focus: "top" },
      ...
      { name: "Khushboo Suman", image: "people/alumni/PhD/Khushboo.jpg", linkedin: "https://www.linkedin.com/in/khushboo-suman-96430b62?utm_source=share_via&utm_content=profile&utm_medium=member_android", year: "2020", focus: "top" },
...
function renderPeople(section, program) {
  ...
  peopleList.forEach(person => {
    ...
    card.innerHTML = `
      ...
      <h3 style="line-height: 1.4;">${displayName}</h3>
      ${detailsHtml}
    `;
...
function setupTabs(section) {
  ...
  const programs = ['PostDoc', 'PhD', 'Masters'];
